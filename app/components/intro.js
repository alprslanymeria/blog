...
export default function Intro() {
    return (
        <div className="flex flex-col items-center p-6 space-y-6 md:space-y-12 lg:space-y-16">
            ...
            <div className="flex flex-col md:flex-row items-center md:justify-between w-full space-y-6 md:space-y-0 md:space-x-8">
                
                <div className="max-w-lg text-center md:text-left">
                    <h1 className="text-2xl font-bold mb-4">Hey, It's İdris Alparslan</h1>
